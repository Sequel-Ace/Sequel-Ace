...
With Sequel Ace, you can write custom queries, or utilize the built-in filtering system to scope down to just what you're looking for. SSH, socket, local, and AWS IAM connections are all supported, making all your databases accessible with ease.
