...
@objc protocol SAVaultRoleListControllerDelegate: AnyObject {
    ...
    /// The window is closing or the connection was cancelled — drop any response.
    ...
    @objc func refresh() {
        ...
        DispatchQueue.global(qos: .userInitiated).async { [weak self] in
            ...
            DispatchQueue.main.async {
                ...
                // Window closing / connection cancelled (which aborts the login):
                // drop the response without touching the torn-down UI.
