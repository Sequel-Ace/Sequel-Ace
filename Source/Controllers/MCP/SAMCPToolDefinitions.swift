        ...
        return [
            ...
            makeTool(name: "run_query",
                     ...
                     properties: [
                        ...
                        "params": ["type": "array", "items": ["type": ["string", "number", "boolean", "null"]], "description": "Values bound to ? placeholders, in order. Without params (missing or empty) the SQL is sent as written: a ? outside string literals and comments then reaches the server, which rejects it as a syntax error."],
